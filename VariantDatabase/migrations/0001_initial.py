# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-11-20 15:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('1', 'Awaiting First Check'), ('2', 'Awaiting Second Check'), ('3', 'Complete'), ('4', 'Invalid')], max_length=1)),
                ...
                ('final_check_date', models.DateTimeField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
