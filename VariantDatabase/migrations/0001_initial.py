# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-11-10 15:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='final_user', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            name='SampleGeneFilterGene',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gene', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='VariantDatabase.Gene')),
                ('sample_gene_filter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='VariantDatabase.SampleGeneFilter')),
            ],
        ),
        migrations.CreateModel(
            name='Section',
        ...
        migrations.AddField(
            model_name='samplegenefilter',
            name='subsection',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='VariantDatabase.SubSection'),
        ),
        migrations.AddField(
            model_name='sample',
            name='sample_gene_filter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='VariantDatabase.SampleGeneFilter'),
        ),
        migrations.AddField(
            model_name='sample',
            name='worksheet',
