# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-11-23 11:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gene', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='VariantDatabase.Gene')),
                ('panel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='VariantDatabase.Panel')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('1', 'Awaiting First Check'), ('2', 'Awaiting Second Check'), ('3', 'Awaiting Resolution'), ('4', 'Complete'), ('5', 'Invalid')], max_length=1)),
                ('creation_date', models.DateTimeField()),
                ('first_check_date', models.DateTimeField(blank=True, null=True)),
                ('second_check_date', models.DateTimeField(blank=True, null=True)),
                ('resolver_date', models.DateTimeField(blank=True, null=True)),
                ('locked', models.BooleanField(default=False)),
            ],
        ),
        migrations.CreateModel(
            name='ReportVariantSampleClassification',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('classification1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='classification1', to='VariantDatabase.Classification')),
                ('classification2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='classification2', to='VariantDatabase.Classification')),
                ('final_classification', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='final_classification', to='VariantDatabase.Classification')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('1', 'New Sample'), ('2', 'Report Complete'), ('3', 'Invalid')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_filter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='VariantDatabase.SampleFilter')),
        ...
        migrations.AddField(
            model_name='reportvariantsampleclassification',
            name='variant',
        ...
        migrations.AddField(
            model_name='report',
            name='default_filter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='VariantDatabase.SampleFilter'),
        ),
        migrations.AddField(
            model_name='report',
            name='first_checker',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='first_checker', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='report',
            name='lock_user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lock_user', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='report',
            name='panel',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='VariantDatabase.Panel'),
        ),
        migrations.AddField(
            model_name='report',
            name='report_creator',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='report_creator', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='report',
            name='resolver',
        ...
        migrations.AddField(
            model_name='report',
            name='second_checker',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='second_checker', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='panel',
            name='subsection',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='VariantDatabase.SubSection'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='subsection',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='VariantDatabase.SubSection'),
        ),
    ]
