  ...
  $.fn.partsSelector = function( options ) {
    ...
    $(this).on('click', '.moveto.parts', function() {
      ...
      if ($c > 0) {
        ...
        $($i).find('.parts.list ul').append($($i).find('.selected.list li.selected').removeClass('selected').addClass('just moved'));
        removeMoved();
        $($i).removeClass('selected-selected');
    ...
    $(this).on('click', '.moveto.selected', function() {
      ...
      if ($c > 0) {
        ...
        $($i).find('.selected.list ul').append($($i).find('.parts.list li.selected').removeClass('selected').addClass('just moved'));
        removeMoved();
        $($i).removeClass('parts-selected');
        settings.callback.call(this);
      } else {
    ...
    if (settings.itemButtons == true) {
      ...
      $(this).on('click', '.parts.list li .add.item-button', function() {
        ...
        // item
        $($i).find('.selected.list ul').append($($(this).closest('li')).addClass('just moved'));
        // selected items
        $($i).find('.selected.list ul').append($($i).find('.parts.list li.selected').removeClass('selected').addClass('just moved'));
        removeMoved();
        $($i).removeClass('parts-selected');
      ...
      $(this).on('click', '.selected.list li .remove.item-button', function() {
        ...
        var $i = $($item).closest('.parts-selector');
        // item
        $($i).find('.parts.list ul').append($($(this).closest('li')).addClass('just moved'));
        // selected items
        $($i).find('.parts.list ul').append($($i).find('.selected.list li.selected').removeClass('selected').addClass('just moved'));
        removeMoved();
        $($i).removeClass('selected-selected');
